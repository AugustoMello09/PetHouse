...
import io.gitHub.AugustoMello09.PetHouse.repositories.PlanoVeterinarioRepository;
import io.gitHub.AugustoMello09.PetHouse.repositories.UsuarioRepository;
import io.gitHub.AugustoMello09.PetHouse.services.PlanoVeterinarioService;
...
public class PlanoVeterinarioServiceImpl implements PlanoVeterinarioService {
	...
	public Page<PlanoDTO> listAll(Pageable page) {
		Page<PlanoVeterinario> plano = repository.findAll(page);
		return plano.map(x -> mapper.map(x, PlanoDTO.class));
	}
