...
public class ProdutoController {
	...
	@PatchMapping(value = "/{produtoId}/img")
	public ResponseEntity<Void> uploadfile(@PathVariable Long produtoId, @RequestParam("imagem") MultipartFile imagem) throws IOException {
		service.uploadfile(produtoId, imagem);
		return ResponseEntity.ok().build();
	}
